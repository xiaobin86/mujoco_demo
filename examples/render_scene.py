"""Render one frame of the PandaPickEnv and save it as an image."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=str, default="panda_pick_scene.png")
    args = parser.parse_args()

    env = PandaPickEnv(render_mode="rgb_array")
    env.reset(seed=0)
